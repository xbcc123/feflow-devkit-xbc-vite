...
<h1 align="center">feflow-devkit-vite</h1>
feflow-devkit-vite 为feflow套件 支持编译指定React，Vue项目模板 通过配置套件配置可以定制化项目编译参数
...
```js
{
    "devkit": {
        "commands": {
            "dev": {
                "builder": "feflow-devkit-vite:dev",
            ...
            "test": {
                "builder": "feflow-devkit-vite:test",
                "options": {
                    "isMinicss": true
                }
            },
            "formalTest": {
                "builder": "feflow-devkit-vite:formalTest",
                "options": {
                    "isMinicss": true
                }
            },
            "demo": {
                "builder": "feflow-devkit-vite:demo",
                "options": {
                    "isMinicss": true
                }
            },
            "build": {
                "builder": "feflow-devkit-vite:build",
                "options": {
                    "port": 8003,
                    "isMinicss": true,
                }
